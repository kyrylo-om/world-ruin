...
namespace wr::rendering {
    ...
    public:
        ...
        [[nodiscard]] const sf::Texture& getBannerSlotsTexture() const noexcept { return m_texBannerSlots; }
        [[nodiscard]] const sf::Texture& getBadgeRedTexture() const noexcept { return m_texBadgeRed; }
        [[nodiscard]] const sf::Texture& getBadgeBlueTexture() const noexcept { return m_texBadgeBlue; }
        ...
        [[nodiscard]] const sf::Texture& getPawnIdleHammerTexture() const noexcept { return m_texPawnIdleHammer; }
        [[nodiscard]] const sf::Texture& getPawnRunHammerTexture() const noexcept { return m_texPawnRunHammer; }
        [[nodiscard]] const sf::Texture& getPawnAttackHammerTexture() const noexcept { return m_texPawnAttackHammer; }
        ...
        [[nodiscard]] const sf::Texture& getHouse1Texture() const noexcept { return m_texHouse1; }
    ...
    private:
        ...
        sf::Texture m_texBannerSlots, m_texBadgeRed, m_texBadgeBlue;

        sf::Texture m_texHouse1;
        ...
        sf::Texture m_texPawnIdleHammer, m_texPawnRunHammer, m_texPawnAttackHammer;
