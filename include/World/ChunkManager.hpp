...
namespace wr::world {
    ...
    public:
        ...
        [[nodiscard]] const Chunk* getChunkThreadSafe(math::Vec2i64 chunkCoord) const noexcept;
    ...
    private:
        ...
        void spawnEntityForChunk(const math::Vec2i64& coord, Chunk& chunk, const EntitySpawnData& data);
