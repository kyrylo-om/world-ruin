...
#include "Input/CursorBuilderSystem.hpp"
...
namespace wr::input {
    ...
    public:
        ...
        void update(const sf::RenderWindow& window, const rendering::Camera& camera, world::ChunkManager& chunkManager, entt::registry& registry, float dt) noexcept;
        ...
        [[nodiscard]] sf::Color getDragColor() const noexcept;
    ...
    private:
        ...
        math::Vec2f m_lastClickPos{-9999.0f, -9999.0f};

        CursorTaskSystem m_taskSystem;
        CursorBuilderSystem m_builderSystem;
